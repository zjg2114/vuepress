...
- 任何一个函数都是闭包 (忘了在哪看的了)
  ...
  ![闭包](../asserts/370991585900147_.pic.jpg)

  发现 inside 对象中有[[Scopes]]数组,其中有两个对象,其中一个是 Closure,另一个 Global,
  Closure 中包含了 out 函数中的活动对象,Global 是全局对象
  先说一下活动对象的含义,比如 out 函数中
  ...
  到这儿基本上都对闭包也有一定的理解了吧,(不装了,摊牌了)我更倾向于
